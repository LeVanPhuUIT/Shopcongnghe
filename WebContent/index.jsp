...
.jssora12r.jssora12rdn {
	...
	<div id="jssor_1"
		...
		<div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
			...
			<div
				style="position: absolute; display: block; background: url('Images/img/loading.gif') no-repeat center center; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
		</div>
		<div data-u="slides"
			...
			<div data-p="141.75" style="display: none;">
				<img data-u="image" src="Images/img/2-bg1.jpg" />
				<div
			...
			<div data-p="141.75" style="display: none;">
				...
				<div
					...
					<img data-u="caption" data-t="0"
						...
						src="Images/img/1-021.png" /> <img data-u="caption" data-t="1"
						style="position: absolute; top: 24px; left: -285px; width: 270px; height: 70px;"
						src="Images/img/1-031.png" />
				</div>
				<div
					...
					<img data-u="caption" data-t="3"
						...
						src="Images/img/1.png" /> <img data-u="caption" data-t="4"
						style="position: absolute; top: 185px; left: 868px; width: 175px; height: 165px;"
						src="Images/img/1-051.png" /> <img data-u="caption" data-t="5"
						style="position: absolute; top: 404px; left: 393px; width: 151px; height: 41px;"
						src="Images/img/1-06.png" />
				</div>
			</div>
			<div data-p="141.75" style="display: none;">
				<img data-u="image" src="Images/img/3-bg1.jpg" />
				<div
